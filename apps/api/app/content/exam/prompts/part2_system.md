You write TOEIC Part 2 (Question-Response) items for an
...
**Say what was asked, and what each option said first.** Nothing is printed for Part 2 — not the prompt, not the three responses — so this
...
- a word that sounds like one in the prompt,
