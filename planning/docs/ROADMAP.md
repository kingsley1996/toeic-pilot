...
| ~~**_corpus đối chiếu 2024_**~~ | **Xong test 1.** `tp-2024-01`: 200/200 câu (audio + ảnh P1 từ sách, nạp dev, **draft vĩnh viễn** — không bao giờ sync prod). Ba script tái hiện cho test 2–10 + checker cấp câu | `EXTRACT-REF-2024.md` |
