...
| `adr/ADR-016-RETRIEVAL-KEEP-VECTOR-WITH-REVISIT.md` | Giữ vector + lexical fallback; số đo và điều kiện xem lại |
...
| `docs/import_media.md` · `docs/EXAM-GENERATION-RUNBOOK.md` · `docs/SYNC-TEST-TO-PRODUCTION.md` · `docs/REGEN-PART-SYNC.md` · `docs/EXTRACT-REF-2024.md` | Runbook thao tác — `REGEN-PART-SYNC` là thay MỘT part của đề đã publish + resync prod; `EXTRACT-REF-2024` là lấy đề giả lập 2024 từ PDF làm reference cho `compare` |
